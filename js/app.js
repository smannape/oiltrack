...
(function () {
  ...
  function initPipelinePage() {
    ...
    // ── REFINERIES (310 facilities · Global Energy Observatory + web-verified coordinates) ────
    [
[22.38,70.05,"Jamnagar Refinery","India","Reliance Industries",1240,'ACTIVE'],
      ...
      [33.92,-118.21,"Torrance Refinery (PBF Energy)","USA","PBF Energy",166,'ACTIVE'],
      ...
      [25.09,51.61,"Laffan Refinery 2","Qatar","QatarEnergy/TotalEnergies",146,'ACTIVE'],
    ...
    document.querySelectorAll('#page-pipeline .pl-layer-cb').forEach(function(cb) {
      cb.addEventListener('change', function() {
        ...
        if (statEl) statEl.textContent = document.getElementById('pl-cb-refinery').checked ? '310' : '\u2014';
      });
    });
