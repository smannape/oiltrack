...
(function () {
  ...
  function initPipelinePage() {
    ...
    // ── REFINERIES (390 facilities · GEO.org + LatAm + Middle East) ────────────────────────
    [
[22.38,70.05,"Jamnagar Refinery","India","Reliance Industries",1240,'ACTIVE'],
      ...
      [34.939,43.489,"Baiji North Refinery","Iraq","INOC",150,'ACTIVE'],
      ...
      [25.01,55.07,"Jebel Ali Refinery (ENOC)","UAE","ENOC",140,'ACTIVE'],
      ...
      [10.1633,-64.7533,"Petrozuata Refinery","Venezuela","Conoco/PDVSA",140,'ACTIVE'],
      ...
      [10.1633,-64.7533,"Operadora Cerro Negro","Venezuela","Exxon/PDVSA",120,'ACTIVE'],
      [35.18,35.94,"Banias Refinery","Syria","SPC",120,'ACTIVE'],
      [12.77,45.03,"Aden Refinery","Yemen","Aden Refinery Co.",120,'ACTIVE'],
      ...
      [34.73,36.68,"Homs Refinery","Syria","SPC",107,'ACTIVE'],
      ...
      [25.11,56.36,"Fujairah Refinery (METRO Oil)","UAE","METRO Oil",82,'ACTIVE'],
      ...
      [21.3833,39.24,"Jeddah Refinery","Saudi Arabia","Saudi Aramco",80,'ACTIVE'],
      [22.15,-80.45,"Cienfuegos Refinery","Cuba","Cupet",76,'ACTIVE'],
      [34.92,43.47,"Baiji South Refinery","Iraq","INOC",75,'ACTIVE'],
      [36.3,59.61,"Mashhad Refinery","Iran","NIODC",75,'ACTIVE'],
      ...
      [36.37,43.16,"Mosul North Refinery","Iraq","INOC",70,'ACTIVE'],
      [34.56,43.52,"Salah al-Din Refinery 3","Iraq","INOC",70,'ACTIVE'],
      [34.62,43.49,"Salah al-Din North Refinery 2","Iraq","INOC",70,'ACTIVE'],
      ...
      [25.37,55.47,"Hamriyah Refinery","UAE","Sharjah NPC",55,'ACTIVE'],
      ...
      [29.62,52.43,"Shiraz Refinery","Iran","NIODC",50,'ACTIVE'],
      [26.79,53.35,"Lavan Island Refinery","Iran","NIODC",50,'ACTIVE'],
      [20.5,44.75,"Khurais Refinery","Saudi Arabia","Saudi Aramco",50,'ACTIVE'],
      ...
      [30.42,49.08,"Bandar Imam Refinery","Iran","NIODC",45,'ACTIVE'],
      [29.53,35.0,"Aqaba Special Economic Zone","Jordan","JRPC",42,'ACTIVE'],
      ...
      [31.05,46.25,"Nasiriyah Refinery","Iraq","INOC",30,'ACTIVE'],
      [35.49,46.07,"Khanaqin Alwand Refinery","Iraq","INOC",30,'ACTIVE'],
      [31.89,54.37,"Yazd Refinery","Iran","NIODC",30,'ACTIVE'],
      [-38.777,-62.2934,"Bahia Blanca Refinery","Argentina","Petrobras Energia",29,'ACTIVE'],
      [34.32,47.07,"Kermanshah Refinery","Iran","NIODC",25,'ACTIVE'],
      ...
      [30.29,57.07,"Kerman Refinery","Iran","NIODC",22,'ACTIVE'],
      ...
      [31.92,47.41,"Samawah Refinery","Iraq","INOC",20,'ACTIVE'],
      [35.89,43.19,"Qayyarah Refinery","Iraq","INOC",19,'ACTIVE'],
      [10.0,-83.0333,"Puerto Limón Refinery","Costa Rica","Recope",18,'ACTIVE'],
      [34.435,41.066,"Al-Qaim Refinery","Iraq","INOC",17,'ACTIVE'],
      [14.6,-61.0667,"Fort de France Refinery","Martinique","SARA",16,'ACTIVE'],
      [10.5,-71.65,"Bajo Grande Refinery","Venezuela","PDVSA",16,'ACTIVE'],
      [34.11,42.38,"Haditha Refinery","Iraq","INOC",16,'ACTIVE'],
      [32.51,46.02,"Diwaniyah Refinery","Iraq","INOC",16,'ACTIVE'],
      [-52.6167,-70.15,"Gregorio Refinery","Chile","ENAP",15,'ACTIVE'],
      [31.83,47.15,"Amarah Refinery","Iraq","INOC",15,'ACTIVE'],
    ...
    document.querySelectorAll('#page-pipeline .pl-layer-cb').forEach(function(cb) {
      cb.addEventListener('change', function() {
        ...
        if (statEl) statEl.textContent = document.getElementById('pl-cb-refinery').checked ? '390' : '\u2014';
      });
    });
